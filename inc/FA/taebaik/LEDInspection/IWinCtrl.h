...
class ISystem_V1;
class IEvtWinCtrl_V1;
class IWinCtrl_V1 : public IBase
{
public:
...
public:
	virtual void AddIEvent(IEvtWinCtrl_V1* pI) = 0;
...
public:
	...
	virtual bool Initialize(int iImgWidth, int iImgHeight, HWND hWnd, ISystem_V1* pI) = 0;
	...
	virtual void Display_String(TCHAR* pStr, DPoint Pos, COLORREF refcolor = RGB(255, 0, 0)) = 0;
	...
	virtual DPoint IPtoVP(int iImgX, int iImgY) = 0;
	virtual DPoint VPtoIP(int iViewX, int iViewY) = 0;
